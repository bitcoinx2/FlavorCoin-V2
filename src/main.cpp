...
unsigned int nTargetSpacing = 1 * 120; // 2 minute blocks
...
const string strMessageMagic = "FlavorCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
        ...
        else if(pindexBest->nHeight < 15101)
    {
        ...
        else if(pindexBest->nHeight < 21101)
    {
        nSubsidy = 62.5 * COIN; 
    }
        else if(pindexBest->nHeight < 28101)
    {
        nSubsidy = 31.25 * COIN; 
    }
        else if(pindexBest->nHeight < 36101)
    {
        nSubsidy = 15.625 * COIN; 
    }
        else if(pindexBest->nHeight < 45101)
    {
        nSubsidy = 7.813 * COIN; 
    }
        else if(pindexBest->nHeight < 55101)
    {
        nSubsidy = 3.9 * COIN; 
    }
        else if(pindexBest->nHeight < 66101)
    {
        nSubsidy = 1 * COIN; 
    }
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 33 / (365 * 33 + 8);  //default 1% yearly

   	if(pindexBest->nHeight < 1101)
    {
        nSubsidy = 1 * COIN;  
    }    
	else if(pindexBest->nHeight < 3101)
    	...
    	else if(pindexBest->nHeight < 66101)
    {
    	...
    	else if(pindexBest->nHeight > 66100)
    {
        nSubsidy = 5 * COIN;
    }    
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FlavorCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "May 30th, 2016: Australia to sell £8m of seized bitcoins.";
        CTransaction txNew;
        txNew.nTime = 1464643158;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1464643158;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1657062;
        ...
        assert(block.hashMerkleRoot == uint256("0x40656ffe1e614e8b0ddc2054f14cc85a4d2854a37f2eb76b44e8e73628c7127c"));
    ...
    string strPubKey = "04a602ee8c7a561587bd10c60ebd6fc0798141aa7a159aee1a958218e753a6801946700cf0096c17a1832ce4cbdc5097ecb1c2759ce1d05b23dc3156c1a9b2c551";
